...
describe('User Actions', () => {
    ...
    it('should call user api route', async () => {
        ...
        axios.post.mockReturnValue(new Promise((resolve) => resolve({userName: "ElPepe"})));
    ...
    it('should call user with data ', async () => {
        ...
        await createUser('firstName', 'lastName', 'userName', userAuth);
        expect(dispatcher.dispatch.mock.calls[0][0]).toEqual({ type: actionTypes.CREATE_USER, data: {}});
    })
    ...
    it('should call user with data ', async () => {
        ...
        axios.get.mockReturnValue(new Promise((resolve) => resolve({data:{}})));
        await loadUser(authid)
        expect(dispatcher.dispatch.mock.calls[0][0]).toEqual({ type: actionTypes.LOAD_USERS, data: {}});
    })
