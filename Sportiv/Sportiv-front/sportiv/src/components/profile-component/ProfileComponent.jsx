  ...
  return (
    isAuthenticated && (
      <div className='main-profile__container'>
        ...
        <button className="profile-button" onClick={() => logout({ returnTo: "http://localhost:3000" })}>
          Logout
        </button>
      ...
      <form className="profile-form">
          ...
          {saveButton &&
            <button className="save-button profile-button" type="submit" onClick={(event) => onCreate(event, firstName,lastName ,userName, user)}>Save Changes</button>
          }
          <p className="form-advise">*You are new and we are happy to have you here! Fill this form please(only this time)</p>
        </form>
